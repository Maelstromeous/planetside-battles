 ...
 * StatsWeaponsTotals
 *
 * @ORM\Table(name="ws_weapons_totals", uniqueConstraints={@UniqueConstraint(name="weaponResultTotals", columns={"weaponID", "resultID"})})
 * @ORM\Entity
 */
class StatsWeaponsTotals
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Matches", inversedBy="statsweaponstotals")
     * @ORM\JoinColumn(name="resultID", referencedColumnName="id")
     */
    private $match;

    /**
    * @ORM\Column(name="weaponID", type="smallint", nullable=false)
    */
    private $weaponID;
